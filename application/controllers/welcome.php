...
class Welcome extends CI_Controller {
	...
	public function index(){
            ...
            //print_r($books);
            $array=array();
				$array['blog_entries'][0]["title"]="<font color='red'>There is no blog entries!</font>";
                $array['blog_entries'][0]["body"]="";
                $array['blog_entries'][0]["date"]="";
                $array['blog_entries'][0]["date_unicode"]="";
                $array['blog_entries'][0]["sender_id"]="";
				$array['blog_entries'][0]["id"]="";
            $k=0;
